...
// export default function EditAnnouncement({ open, handleClose, props })  {
...
//         <Button disabled={inputs.title === ''&&inputs.content=== ''} onClick={handleDelete} color="primary">確認送出</Button>
//         {/* 成功小綠框 */}
